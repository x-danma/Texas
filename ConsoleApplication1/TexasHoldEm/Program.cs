...
namespace TexasHoldEm
{
    public class Program
    {
        ...
        static List<TexasHandAsserter> TexasHoldEmHandAsserters = new List<TexasHandAsserter>();
        ...
        {
            TexasHoldEmHandAsserters.Add(new StraightFlush());
            TexasHoldEmHandAsserters.Add(new FourOfAKind());
            TexasHoldEmHandAsserters.Add(new FullHouse());
            TexasHoldEmHandAsserters.Add(new ThreeOfAKind());
            TexasHoldEmHandAsserters.Add(new TwoPairs());
            TexasHoldEmHandAsserters.Add(new Pair());
        }
